...
wget -qO "pc/h-encore.7z" "https://github.com/soarqin/finalhe/releases/download/v1.92/FinalHE_v1.92_win32.7z"
wget -qO "pc/qcmadriver.exe" "https://github.com/soarqin/finalhe/releases/download/v1.91/QcmaDriver_winusb.exe"
...
wget -qO "vita/vpks/enso.vpk" "https://github.com/henkaku/enso/releases/download/v1.1/enso.vpk"
# Shit is archived on github, might use a fork in the future

echo "Downloading vitashell"
wget -qO "vita/vpks/vitashell.vpk" "https://github.com/TheOfficialFloW/VitaShell/releases/download/v2.02/VitaShell.vpk"
# Has not updated in over a year, if it updates I'll change it back to an API call

echo "Downloading config.txt"
wget -qO "vita/tai/config.txt" "https://vita.hacks.guide/assets/files/config.txt"

# Nothing below updates, just pull and don't use API

echo "Downloading NoNpDrm"
wget -qO "vita/tai/nonpdrm.skprx" "https://github.com/TheOfficialFloW/NoNpDrm/releases/download/v1.2/nonpdrm.skprx"

echo "Downloading 0syscall6" 
wget -qO "vita/tai/0syscall6.skprx" "https://github.com/SKGleba/0syscall6/releases/download/v1.3/0syscall6.skprx"

echo "Downloading Download Enabler"
wget -qO "vita/tai/download_enabler.suprx" "https://github.com/TheOfficialFloW/VitaTweaks/releases/download/DownloadEnabler/download_enabler.suprx"

echo "Downloading shellbat"
wget -qO "vita/tai/shellbat.suprx" "https://github.com/nowrep/vita-shellbat/releases/download/r10/shellbat.suprx"

echo "Downloading pngshot"
wget -qO "vita/tai/pngshot.suprx" "https://github.com/xyzz/pngshot/releases/download/v1.3/pngshot.suprx"

echo "Downloading PSVshell"
wget -qO "vita/tai/PSVshell.skprx" "https://github.com/Electry/PSVshell/releases/download/v1.1/PSVshell.skprx"
